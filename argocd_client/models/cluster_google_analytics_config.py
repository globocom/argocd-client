...
class ClusterGoogleAnalyticsConfig(object):
    ...
    def __init__(self, anonymize_users=None, tracking_id=None, local_vars_configuration=None):  # noqa: E501
        """ClusterGoogleAnalyticsConfig - a model defined in OpenAPI"""  # noqa: E501

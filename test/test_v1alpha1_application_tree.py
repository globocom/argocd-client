...
from argocd_client.models.v1alpha1_application_tree import V1alpha1ApplicationTree  # noqa: E501
...
class TestV1alpha1ApplicationTree(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = argocd_client.models.v1alpha1_application_tree.V1alpha1ApplicationTree()  # noqa: E501
        if include_optional :
            return V1alpha1ApplicationTree(
                nodes = [
                    argocd_client.models.resource_node_contains_information_about_live_resource_and_its_children.ResourceNode contains information about live resource and its children(

...
from argocd_client.models.v1alpha1_sync_operation_result import V1alpha1SyncOperationResult  # noqa: E501
...
class TestV1alpha1SyncOperationResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = argocd_client.models.v1alpha1_sync_operation_result.V1alpha1SyncOperationResult()  # noqa: E501
        if include_optional :
            return V1alpha1SyncOperationResult(
                resources = [

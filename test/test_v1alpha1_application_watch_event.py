...
from argocd_client.models.v1alpha1_application_watch_event import V1alpha1ApplicationWatchEvent  # noqa: E501
...
class TestV1alpha1ApplicationWatchEvent(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = argocd_client.models.v1alpha1_application_watch_event.V1alpha1ApplicationWatchEvent()  # noqa: E501
        if include_optional :
            return V1alpha1ApplicationWatchEvent(
                application = argocd_client.models.application_is_a_definition_of_application_resource/
+genclient
+genclient:no_status

...
from argocd_client.models.v1alpha1_sync_operation import V1alpha1SyncOperation  # noqa: E501
...
class TestV1alpha1SyncOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = argocd_client.models.v1alpha1_sync_operation.V1alpha1SyncOperation()  # noqa: E501
        if include_optional :
            return V1alpha1SyncOperation(
                dry_run = True, 
                manifests = [
                    '0'
                    ], 
